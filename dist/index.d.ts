...
interface RuleOptions {
   ...
   * @see https://github.com/gajus/eslint-plugin-jsdoc/blob/main/docs/rules/required-tags.md#repos-sticky-header
   */
  'jsdoc/required-tags'?: Linter.RuleEntry<JsdocRequiredTags>;
  /**
...
declare function formatters(options?: OptionsFormatters | true, stylistic?: StylisticConfig, markdownParserEnabled?: boolean): Promise<TypedFlatConfigItem[]>;
//#endregion
...
declare const GLOB_MARKDOWN_OR_MDX = "**/*.{md,mdx}";
declare const GLOB_MARKDOWN_OR_MDX_IN_MARKDOWN_OR_MDX = "**/*.{md,mdx}/*.{md,mdx}";
